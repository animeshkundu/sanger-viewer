...
test.describe('annotation track with loaded trace', () => {
  ...
  test('renders annotation chips and keeps viewport-windowed visibility metadata', async ({ page }) => {
    ...
    await expect(track.locator('.annotation-chip', { hasText: 'ORF +2 88-103' })).toBeVisible()
    await expect(track.locator('.annotation-chip', { hasText: 'HindIII 251-257' })).toBeVisible()
