...
- Keep this repository client-side only (no backend).
- Validate parser and rendering changes with fixture-driven tests.
- Do not deploy/merge without explicit human approval.
